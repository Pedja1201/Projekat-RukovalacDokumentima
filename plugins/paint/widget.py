...
class Window(QMainWindow):
    def __init__(self):
        ...
        icon = "resources/icons/singi.jpg"
        ...
        clearAction = QAction(QIcon("resources/icons/clear.jpeg"), "Clear", self)
        ...
        blackAction = QAction(QIcon("resources/icons/black.png"), "Black", self)
        blackAction.setShortcut("Ctrl+B")
        brushColor.addAction(blackAction)
        blackAction.triggered.connect(self.blackColor)
 
 
        whitekAction = QAction(QIcon("resources/icons/white.png"), "White", self)
        whitekAction.setShortcut("Ctrl+W")
        brushColor.addAction(whitekAction)
        whitekAction.triggered.connect(self.whiteColor)
 
 
        redAction = QAction(QIcon("resources/icons/red.png"), "Red", self)
        redAction.setShortcut("Ctrl+R")
        brushColor.addAction(redAction)
        redAction.triggered.connect(self.redColor)
 
        greenAction = QAction(QIcon("resources/icons/green.png"), "Green", self)
        greenAction.setShortcut("Ctrl+G")
        brushColor.addAction(greenAction)
        greenAction.triggered.connect(self.greenColor)
 
        yellowAction = QAction(QIcon("resources/icons/yellow.png"), "Yellow", self)
